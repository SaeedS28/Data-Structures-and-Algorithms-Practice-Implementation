...
public class NineToFourConverter {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nTotal Grade Points (York): "+coursePointsYork+"\tTotal Credits Taken: "+totalCredits);
		yorkGPA=coursePointsYork / (double)totalCredits;
		System.out.printf("Your York GPA is: %.2f\n\n",yorkGPA);
		
		System.out.printf("Total Grade Points (4-Scale): %.3f\tTotal Credits Taken: %.0f\n", coursePointsFourScale, totalCredits);
